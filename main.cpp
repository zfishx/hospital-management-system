...
bool checklogin()
{
    ...
    {
        if(i.second.getname() == username && i.second.getpassword() == password)
        {
...
void prescriptionMenu()
{
    ...
    while (!exit)
    {
        ...
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "./HOME/PRESCRIPTION\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "[01] : Write a prescription\n";
        cout << "[02] : view prescription\n";
...
void bedMenu()
{
    ...
    while (!exit)
    {
        ...
        cout << "./HOME/BEDS\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "[01] : search a patient's bed number\n";
        cout << "[02] : Show all beds info\n";
        cout << "[-1] : Back\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
        cout << "Enter your choice: ";
        cin >> purpose;
